                ...
                <div class="form-group row">
                    ...
                    <div class="col">
                        <input type="number" class="form-control" id="id" aria-describedby="idHelp"
                            placeholder="Introduzca id" value="{{ $sexo->id }}" readonly>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-1 pl-1">
                    ...
                    <div class="col">
                        <input type="text" class="form-control" id="nombre" aria-describedby="nombreHelp"
                            placeholder="Introduzca nombre" value="{{ $sexo->nombre }}" readonly>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-1 pl-1">
                    ...
                    <div class="col">
                        <input type="text" class="form-control" id="diputados" aria-describedby="diputadosHelp"
                            placeholder="Introduzca diputados" value="{{ $sexo->diputados() }}" readonly>
                    </div>
                </div>
